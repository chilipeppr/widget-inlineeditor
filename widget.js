...
requirejs.config({
    ...
    */
    paths: {
        ...
        AceLangTools: 'https://rawgithub.com/ajaxorg/ace-builds/master/src/ext-language_tools',
    },
    shim: {
        ...
        AceEditorJsx: ["ace"],
        AceLangTools: ["ace"],
        aceAutoCompletion: ["ace", "AceEditorHtml", "AceEditorCss", "AceEditorJavascript", "AceEditorJsx", 'AceLangTools'],
    }
});
        ...
        loadAce: function(aceid, sampleContent, aceMode) {
            ...
            if ('ace' in window && ace) { // && 'setValue' in ace) {
                ...
                if (this.aceIsLoaded[aceid]) {
                    ...
                    // set our own auto-completion
                    var langTools = ace.require("ace/ext/language_tools");
                    var zipwhipCompleter = {
                        getCompletions: function(editor, session, pos, prefix, callback) {
                            var range = editor.getSelectionRange();
                            console.log("getCompletions called. pos:", pos, "prefix:", prefix, "range:", range, "editor:", editor, "session:", session);
                            // see if preceding characters are Zipwhip
                            // range.end = pos;
                            // range.start.
                    ...
                    langTools.addCompleter(zipwhipCompleter);
